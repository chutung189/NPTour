...
<p style="font-size: 16px; font-family: Arial, sans-serif; color: #333;">Cảm ơn bạn đã đặt tour tại NPTour. Vui lòng xem chi tiết hóa đơn trong file đính kèm.</p>
        ...
        <section class="content invoice">
            ...
            <div class="row invoice-info" style="margin-bottom: 20px;">
                ...
                <div class="col-sm-4 invoice-col" style="font-size: 14px;">
                    Đến
                    <address>
                        <strong>Công ty NPTour</strong><br>
                        470 Trần Đại Nghĩa<br>
                        Ngũ Hành Sơn, Hà Nội<br>
